...
const StaffTopBar = ({ onMenuClick, isSidebarOpen }) => {
  ...
  const getPageTitle = () => {
    ...
    if (path.includes('/staff/search')) return 'Search Patient';
    if (path.includes('/staff/patient')) return 'Patient Record';
    if (path.includes('/staff/pending')) return 'Pending Requests';

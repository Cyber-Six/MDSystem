        ...
        {filtered.length === 0 ? (
          ...
          <div className="divide-y divide-neutral-100 dark:divide-neutral-700/60 -mx-3 -mb-3">
            {filtered.map((consult, idx) => (
              <article
                key={idx}
                className="px-3 py-3 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 transition-colors cursor-pointer"
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-[11px] text-primary-600 dark:text-primary-400 font-medium">

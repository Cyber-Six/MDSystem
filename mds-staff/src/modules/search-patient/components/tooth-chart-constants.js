...
export const LEGENDS = [
  { code: '✓', label: 'Caries-free', color: 'bg-green-100 border-2 border-green-500 dark:bg-white dark:border-neutral-300', textColor: 'text-green-700 dark:text-neutral-900' },
  ...
  { code: 'M', label: 'Missing', color: 'bg-gray-200 border border-gray-600 dark:bg-gray-700 dark:border-gray-600', textColor: 'text-gray-900 dark:text-gray-200' },
  ...
  { code: 'FD', label: 'Full Denture', color: 'bg-yellow-100 border border-yellow-500 dark:bg-yellow-200 dark:border-yellow-600', textColor: 'text-yellow-800 dark:text-yellow-900' },
];

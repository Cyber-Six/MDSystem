        ...
        >
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-warning-500 pl-4">
              <h4 className="font-semibold text-secondary-700 dark:text-white mb-3">Smoker</h4>
              <div className="flex gap-4 mb-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-secondary-700 dark:text-neutral-300">No</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="form-checkbox"
                  />
                  <span className="ml-2 text-secondary-700 dark:text-neutral-300">Yes</span>
                </label>
              </div>
              {formData.smoker === 'yes' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="border-l-4 border-accent-500 pl-4">
              <h4 className="font-semibold text-secondary-700 dark:text-white mb-3">Alcohol Drinker</h4>
              <div className="flex gap-4 mb-4">
                <label className="flex items-center">
                  <input
                    type="radio"
            ...
            <div className="border-l-4 border-primary-500 pl-4">
              <h4 className="font-semibold text-secondary-700 dark:text-white mb-3">Vaper</h4>
              <div className="flex gap-4 mb-4">
                <label className="flex items-center">
                  <input
                    type="radio"

# usAnalytics Module Implementation
...
{
  "dataTypes": ["consultations-by-type", "appointments-by-mode", ...],
  "branch": "Both",
...
## Available Analytics Queries (15 total)
...
| `consultations-by-mode`   | Doughnut   | Virtual vs Onsite breakdown                 |

...
| `EXPO_PUBLIC_ENABLE_GOOGLE_OAUTH` | No | Enables the Google sign-in section. Defaults to `false`. |
| `EXPO_PUBLIC_ENABLE_RECAPTCHA` | No | Enables sending the mobile reCAPTCHA token in auth flows. Defaults to `false`. |

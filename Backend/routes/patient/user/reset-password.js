...
// 1. POST /auth/reset-password - Initiate password reset by sending OTP
// 2. POST /auth/reset-password/verify - Confirm OTP and establish reset session
// 3. POST /auth/reset-password/new - Update password with reset session

...
const PersonalInfoStep = ({ formData, onChange }) => {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-xl p-6">
      ...
      {/* Name Fields - Separated into First, Last, and Middle Initial */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <Input
          ...
          placeholder="Boarding House Address (if applicable)"
          value={formData.boardingAddress || ''}
          onChange={(e) => handleInputChange('boardingAddress', e.target.value)}
        />
      </div>
      ...
      <div className="mt-8">
        <div className="flex items-center gap-3 mb-4 pb-3 border-b border-neutral-200 dark:border-neutral-700">
          <div className="w-8 h-8 rounded-lg bg-error-100 dark:bg-error-500/20 flex items-center justify-center">
        ...
        <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-5 mb-4 bg-white dark:bg-neutral-900 hover:border-primary-400 dark:hover:border-primary-500 transition-colors duration-200">
        ...
        <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-5 bg-white dark:bg-neutral-900 hover:border-primary-400 dark:hover:border-primary-500 transition-colors duration-200">
